...
description: Learn about the tooling for each step for the blocklet workflow
---
...
- [DID Domain](https://domain.didlabs.org) Uniq domain with HTTPS enabled to ease the development process.
...
- [DID Domain](https://domain.didlabs.org) Uniq domain with HTTPS enabled to ease the setup process.
